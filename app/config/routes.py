...
routes['GET']['/show/<id>']='Restfuls#show'
routes['GET']['/edit/<id>']='Restfuls#edit'
routes['GET']['/new']='Restfuls#new'
routes['POST']['/create']='Restfuls#create'
routes['GET']['/destroy/<id>']='Restfuls#destroy'
